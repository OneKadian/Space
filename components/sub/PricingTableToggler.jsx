  ...
  return (
    <>
      <label class="inline-flex items-center cursor-pointer">
        ...
        <span class="m-3 text-sm font-medium text-white">Monthly Billing</span>
        <Switch
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 w-4/5">
          {prices.map((price, index) => (
            <div
              id={price.id}
              key={index}
              className="shadow-lg shadow-[#2A0E61]/50 bg-[#7165b527] backdrop-blur-md px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10 flex flex-col p-6 text-center rounded-xl min-h-[500px] justify-center"
            >
              ...
              <CustomLink
                ...
                className={`text-white bg-purple-700 ${price.buttonDisplay} font-medium rounded-lg text-sm px-5 py-2.5 text-center`}
              />
            </div>
          ))}
        </div>
