                ...
                <div className="ms-3 text-sm font-normal">
                  ...
                  <div className="grid grid-cols-1 gap-2 h-10">
                    ...
                    <div>
                      <Link
                        href="/sign-in"
                        className="inline-flex justify-center items-center w-3/4 h-full px-2 py-1.5 text-xs font-medium text-center text-white bg-purple-600 rounded-lg hover:bg-purple-700 focus:ring-4 focus:outline-none focus:ring-blue-300"
                      >
                        Login
                      </Link>
                    </div>
...
//     // Initialize toastDisplay to true only once
//     return true;
//   });
